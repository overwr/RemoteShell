...
def CheckModeBLC(Side):
    if Side == S.ClientSide and S.Mode == S.ClientToServerMode:
        print("1")
        return CreateBLC(1)
    elif Side == S.ClientSide and S.Mode == S.ServerToClientMode:
        print("2")
        return CreateBLC(0)
    
    if Side == S.ServerSide and S.Mode == S.ClientToServerMode:
        print("3")
        return CreateBLC(0)
    elif Side == S.ServerSide and S.Mode == S.ServerToClientMode:
        print("fdf")
        return CreateBLC(1)
